!function(t, i, e) {
    ...
    var T = function() {
        ...
        return s.destroy = function(i) {
            ...
            this._bg.skin = this._skin, this._bar.skin = this._skin.replace(".png", "%24bar.png"), 
        ...
        return s.destroy = function(i) {
            ...
            this._showButtons && (this.upButton.skin = this._skin.replace(".png", "%24up.png"), 
            this.downButton.skin = this._skin.replace(".png", "%24down.png")), this.slider.isVertical ? this.slider.y = this._showButtons ? this.upButton.height : 0 : this.slider.x = this._showButtons ? this.upButton.width : 0, 
            ...
            " " != t && this._skin != t && (this._skin = t, this._skin && !m.getRes(this._skin) ? e.loader.load([ this._skin, this._skin.replace(".png", "%24up.png"), this._skin.replace(".png", "%24down.png"), this._skin.replace(".png", "%24bar.png") ], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }), h(0, s, "max", function() {
        ...
        return o.destroy = function(i) {
            ...
            this._bg.skin = this._skin, this._bar.skin = this._skin.replace(".png", "%24bar.png");
            var t = this._skin.replace(".png", "%24progress.png");
            ...
            this._skin != t && (this._skin = t, this._skin && !m.getRes(this._skin) ? e.loader.load([ this._skin, this._skin.replace(".png", "%24bar.png") ], f.create(this, this._skinLoaded)) : this._skinLoaded());
        }), h(0, o, "tick", function() {
            return this._tick;
        }, function(t) {
        ...
        return l.getLocalDateString = function(t) {
            ...
            var s = new RegExp("https://html5.gamedistribution.com/", "g");
            ...
            h._http.open("get-2", e, !0), h._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), 
            ...
            return h.getDateFormatStr(t, "https://html5.gamedistribution.com/");
        ...
        return s.setLoadUrl = function() {
            ...
            this._http.open("get-2", s, !0), this._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), 
