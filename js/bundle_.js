...
!function() {
    ...
    1: [ function(t, e, i) {
        ...
        var a = t("./scripts/views/ClearingView"), n = t("./scripts/uiComp/AppLite"), o = t("./scripts/uiComp/AppBanner"), s = t("./scripts/views/CollectView"), r = t("./scripts/views/skinView"), h = t("./scripts/views/GameView"), l = t("./scripts/views/HomeView"), d = t("./scripts/uiComp/WxgameList"), c = t("./scripts/views/LoginView"), u = t("./scripts/views/OverView"), p = t("./scripts/views/RankView"), f = t("./scripts/uiComp/Wxapp"), m = function() {
            function t() {}
    ...
    2: [ function(t, e, i) {
        ...
        var a = t("./GameConfig"), n = t("./scripts/LayaSample"), o = function() {
            function t() {
                ...
                Laya3D.init(a["default"].width,_height);
    ...
    3: [ function(t, e, i) {
        ...
        var a = t("./Utils"), n = t("./manager/StorageMgr"), o = t("./manager/SoundMgr"), s = t("./manager/NetMgr"), r = t("./manager/WxMgr"), h = t("./manager/ConfigMgr"), l = t("./platforms/WxAd"), d = t("./manager/GameMgr"), c = t("./manager/TweenMgr"), u = t("./plug/ModelCreator"), p = function() {
            function t() {}
        ...
        var a = t("./LayaSample"), n = function() {
            ...
            return t.prototype.addClickEvent = function(t, e, i, n) {
                if (t.offAllCaller(e), t instanceof Laya.Button) {
                    ...
                    var s = 60, r = 1, h = (t.anchorX, t.anchorY, t.x * r, t.y * r, t.scaleX * r), l = t.scaleX * r, d = .9 * r, c = function(e) {
                ...
                var i = 0 == e && e ? e : 1, a = [], n = [], o = t.replace(/#/, "");
                if (3 == o.length) {
                ...
                var i = new Laya.TimeLine(), a = t.pivotX;
                ...
                var i = new Date(t), a = i.getFullYear(), n = i.getMonth() + 1, o = i.getDate();
                return a + "-" + e(n) + "-" + e(o);
        ...
        var a = t("../LayaSample"), n = function(t) {
            ...
            return __extends(e, t), e.prototype.init = function() {
                ...
                this.bike.transform.position.y < this.currentHeight) {
                    ...
                    if (this.rotateStatus > 0) for (var e = 0; e < this.rotateStatus; e++) this.speedUp(); else this.anim.crossFade("run", .5);
                    this.fixAngle();
                }
                ...
                var e = 0, i = this.speedZ, a = this.bike.transform.rotationEuler, n = -a.x;
                n > 360 && (n %= 360);
                var o = n > 270 ? 360 : 0;
    ...
    7: [ function(t, e, i) {
        ...
        var a = t("../LayaSample"), n = function(t) {
            ...
            return __extends(e, t), e.prototype.init = function(t) {
                ...
                if (!a["default"].gameMgr.isOver) for (var t = 0; t < this.targets.length; t++) {
                    var e = this.targets[t], i = e.getChild("TargetPos").transform.position, n = this.owner, o = n.transform.position;
                    if (e && e.getBike.transform.position.y < this.height + .7 && i.z < o.z + this.distance) {
                        if (i.z > o.z) {
                            ...
                            this.isLimitLefts[t] = i.x < o.x - this.width, this.isHits[t] && e.hit(); else if (!this.isHits[t]) if (this.isLimitLefts[t]) {
            ...
            return __extends(e, t), e.prototype.init = function() {
                ...
                if (!a["default"].gameMgr.isOver && a["default"].gameMgr.isPlay) {
                    if (this.moveUpdate(), this.rotate(), this.checkAi(), this.wind1.isPlaying) {
                        var t = this.particleAcce2.getChildAt(2), e = t.transform.rotationEuler;
                        e.setValue(190, 0, 0), t.transform.rotationEuler = e;
                    }
                    if (this.wind2.isPlaying) {
                        var t = this.particleAcce3.getChildAt(2), e = t.transform.rotationEuler;
                        e.setValue(190, 0, 0), t.transform.rotationEuler = e;
                    }
                }
            }, e.prototype.moveUpdate = function() {
                ...
                } else for (var i = 0; 2 > i; i++) {
                    var a = this.particleAcce1.getChildAt(i).particleSystem, n = this.particleAcce2.getChildAt(i).particleSystem, o = this.particleAcce3.getChildAt(i).particleSystem;
                ...
                if (!a["default"].gameMgr.isOver) for (var t = 0; t < this.targets.length; t++) {
                    ...
                    if (e && (this.isJumps[t] && !e.isJump || e.getBike.transform.position.y < this.height + 1.9) && i.z < o.z + this.distance + 1) {
                        if (i.z > o.z) {
                            ...
                            this.isLimitLefts[t] = i.x < o.x - this.width, this.isJumps[t] && this.canAcce && e.speedUp(); else if (this.isJumps[t] && i.z < o.z + this.distance - 1.5) {
                                var s = e.getBike.transform.position.clone();
                                s.y = .69 * (i.z - o.z);
    ...
    11: [ function(t, e, i) {
        ...
        var a = function() {
            ...
            return t.prototype.init = function() {}, t.prototype.clear3DRes = function(t, e) {
                ...
                for (var e = 0, i = this.skinCfg.length; i > e; ++e) if (t == this.skinCfg[e].id) return e;
    ...
    13: [ function(t, e, i) {
        ...
        var a = t("../plug/MD5"), n = t("../plug/Dict"), o = t("../LayaSample"), s = function() {
            function t() {
            ...
            return t.prototype.request = function(t, e, i) {
                if ("v10/common/temporaryLogin" == t) console.log("login..."); else {
                ...
                var n = this.host + t, o = this.setParmData(e);
                ...
                var e = t.path, i = this.messageDict.get(e);
    ...
    14: [ function(t, e, i) {
        ...
        var a = t("../LayaSample"), n = function() {
            function t() {
                this._pathRoot = "res/sound/index.html", this._soundCtx = {}, this._soundFile = [];
                for (var t in o) {
                    var e = o[t];
            ...
            return t.prototype.init = function() {
                ...
                this._soundCtx[t] && a["default"].storageMgr.isPlaySound() && Laya.SoundManager.playSound(this._pathRoot + t + ".mp3");
    ...
    15: [ function(t, e, i) {
        ...
        var a = t("../LayaSample"), n = function() {
            ...
            return t.prototype.init = function() {
                ...
                var t = !0, e = this._userData.signinTime;
        ...
        var a = t("../LayaSample"), n = function() {
            ...
            return t.prototype.init = function() {
                ...
                if (Laya.Browser.onWeiXin) {
                    ...
                    window.wx.login({
                        success: function(e) {
                            var i = e.code, n = a["default"].commonData.launchOptions, o = {};
                            ...
                            o.late_version = a["default"].commonData.currentVersion, a["default"].netMgr.request("v10/common/temporaryLogin", o, function(e) {
                                if (0 !== e.code) console.error("code login fault. code:" + e.code); else {
                                    console.log("code 登录成功", e);
                                    var i = e.result, n = "" == i.userInfo.avatar;
                ...
                var t = a["default"].wxMgr, e = a["default"].commonData.wxsysInfo, i = e.screenWidth, n = e.screenHeight, o = (e.screenWidth - i) / 2, s = (e.screenHeight - n) / 2, r = {
                    left: o,
                    top: s,
                    width: i,
                    height: n,
                ...
                t.buttonAuthorize1 = window.wx.createUserInfoButton({
                    ...
                    var i = new Date().getTime(), n = Math.floor((i - t.preTime) / 1e3);
                    if (t.preTime = i, !(1 > n)) {
                        if (e.userInfo) {
                            console.log("用户授权登录");
                            var o = {};
                ...
                a["default"].netMgr.request("v10/skin/lists", e, function(e) {
                    if (0 != e.code) console.error("skin lists error", e); else {
                ...
                var i = t.shareContent, n = i.length, o = 0;
                ...
                for (var h = 0, l = t.wxappList; h < l.length; h++) {
                    var d = l[h], c = a["default"].commonData.wxappList[d.category];
                ...
                if (Laya.Browser.onWeiXin) {
                    var e = t ? "open_lite_rank" : "close_lite_rank", i = window.wx.getOpenDataContext();
                    i.postMessage({
                        cmd: e
                ...
                if (Laya.Browser.onWeiXin) {
                    var e = t ? "open_over_friend" : "close_over_friend", i = window.wx.getOpenDataContext();
                    i.postMessage({
                        cmd: e,
                ...
                if (Laya.Browser.onWeiXin) {
                    var e = t ? "open_loop_friend" : "close_loop_friend", i = window.wx.getOpenDataContext();
                    i.postMessage({
                        cmd: e,
                        score: a["default"].commonData.newScore
                ...
                e._statuShareGame) {
                    e._statuShareGame = !1;
                    var i = new Date().getTime(), n = i - e._shareStartTime, o = 2500 > n ? !1 : !0;
                ...
                if (Laya.Browser.onWeiXin) {
                    var i = a["default"].commonData.wxappList[e], n = "", o = -1, s = -1;
                    if (i) for (var r = 0, h = i; r < h.length; r++) {
                        var l = h[r];
                        if (l.app_id == t) {
                ...
                var e = a["default"].commonData.wxappList[t], i = [];
                if (e) {
                ...
                if (Laya.Browser.onWeiXin) {
                    var i, n = a["default"].wxMgr, o = n.getShareContent(t);
                ...
                var e = a["default"].commonData.shareInfo[t], i = {
    ...
    19: [ function(t, e, i) {
        ...
        var a = t("../LayaSample"), n = t("../../GameConfig"), o = t("./BaseAd"), s = function(t) {
            function e() {
                return null !== t && t.apply(this, arguments) || this;
            }
            return __extends(e, t), e.prototype.init = function() {
                ...
                if (Laya.Browser.onWeiXin && !a["default"].commonData.isNoAds && a["default"].commonData.existBannerAd) {
                    var t = this._bannerList.length, e = null;
                    if (1 > t) e = null; else if (1 == t) e = this._bannerList[0]; else {
                ...
                if (e && t) {
                    var i = a["default"].commonData.wxsysInfo, n = (i.screenWidth - t) / 2;
                ...
                if (Laya.Browser.onWeiXin && !(a["default"].commonData.isSleep || this._bannerList.length > 2)) {
                    var t = this, e = a["default"].commonData.wxsysInfo, i = e.screenWidth, o = (e.screenWidth - i) / 2, s = .86 * e.screenHeight, r = {
                        width: i,
    ...
    21: [ function(t, e, i) {
        ...
        var a = function() {
            ...
            return t.hex_md5 = function(t) {
                ...
                var i = (65535 & t) + (65535 & e), a = (t >> 16) + (e >> 16) + (i >> 16);
                return a << 16 | 65535 & i;
                ...
                for (var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2b/index.html", i = "", a = 0; a < 4 * t.length; a += 3) for (var n = (t[a >> 2] >> 8 * (a % 4) & 255) << 16 | (t[a + 1 >> 2] >> 8 * ((a + 1) % 4) & 255) << 8 | t[a + 2 >> 2] >> 8 * ((a + 2) % 4) & 255, o = 0; 4 > o; o++) i += 8 * a + 6 * o > 32 * t.length ? this.b64pad : e.charAt(n >> 6 * (3 - o) & 63);
                return i;
    ...
    22: [ function(t, e, i) {
        ...
        var a = t("../comp/JumpPlatform"), n = t("../comp/Bike"), o = t("../comp/Barrier"), s = t("../comp/Arrow"), r = t("../LayaSample"), h = t("../comp/AiBike"), l = function(t) {
            function e() {
            ...
            return __extends(e, t), e.prototype.init = function(t) {
                ...
                var e = this;
                this.offset = t;
                var i = Math.floor(100 * Math.random() % this.constructs.length), a = this.constructs[i];
                a.models.forEach(function(t) {
                    e.createConstruct(t);
                });
                ...
                var e = this.constructsPrefab.getChildByName(t.name), i = Laya.Sprite3D.instantiate(e);
                ...
                if (!(0 > t || t > 4)) {
                    var e = this.skins.getChildByName("RoleMatList"), i = this.skins.getChildByName("BikeMatList"), a = this.skins.getChildByName("Effect").clone(), n = this.skins.getChildByName("RoleList");
                    if (0 == t) var o = n.getChildAt(0).clone(); else var o = n.getChildAt(1).clone();
                    var s = null, r = null, h = null;
                    if (t > 1) {
                        switch (t) {
                          case 2:
    ...
    25: [ function(t, e, i) {
        ...
        var a = t("./AppItem"), n = t("../LayaSample"), o = function(t) {
            function e() {
                var e = t.call(this) || this;
            ...
            return __extends(e, t), e.prototype.closeComp = function() {
                ...
                if (this.appCount = t.length, t.length > this.renderCount) for (var e = 0; e < this.renderCount; e++) {
    ...
    30: [ function(t, e, i) {
        ...
        var a = t("../LayaSample"), n = function(t) {
            ...
            return __extends(e, t), e.prototype.onAwake = function() {
                ...
                if (t) {
                    var e = t.width, i = (t.height, Laya.Browser.clientWidth);
                    e != i && (this._isResizeAd = !0, a["default"].adMgr.setBannerAdWidth(i));
                }
            }, e.prototype.tweenAd = function() {
                var t = a["default"].adMgr.getBannerItem();
                if (t) for (var e = (t.width, t.height), i = a["default"].screen.realPxRatio, n = Math.floor(e * i), o = 0; o < this._children.length; ++o) {
    ...
    31: [ function(t, e, i) {
        ...
        var a = t("./BaseView"), n = t("../LayaSample"), o = function(t) {
            function e() {
                return null !== t && t.apply(this, arguments) || this;
            }
            return __extends(e, t), 
    ...
    33: [ function(t, e, i) {
        ...
        var a = t("./BaseView"), n = t("../LayaSample"), o = t("../comp/CameraFollow"), s = t("../comp/Bike"), r = t("../comp/AiBike"), h = function(t) {
            function e() {
                var e = null !== t && t.apply(this, arguments) || this;
    ...
    34: [ function(t, e, i) {
        ...
        var a = t("./BaseView"), n = t("../LayaSample"), o = function(t) {
            ...
            return __extends(e, t), e.prototype.onAwake = function() {
                ...
                this.btnSound = this.getChild("btnSound", t), this.setSound(n["default"].storageMgr.isPlaySound()), 
            ...
            e.prototype.onListRender = function(box){
                box.offAll(Laya.Event.MOUSE_DOWN);
                box.on(Laya.Event.MOUSE_DOWN,box,()=>{platform.getInstance().navigate("HOME","MORE",box.dataSource.id)});
            },
            ...
            }, e.prototype.onSoundClick = function() {
    ...
    37: [ function(t, e, i) {
        ...
        var a = t("../uiComp/RankItem"), n = t("./BaseView"), o = t("../LayaSample"), s = function(t) {
            function e() {
                var e = t.call(this) || this;
    ...
    38: [ function(t, e, i) {
        ...
        var a = t("../uiComp/skinItem"), n = t("../LayaSample"), o = t("./BaseView"), s = function(t) {
            function e() {
                var e = t.call(this) || this;
